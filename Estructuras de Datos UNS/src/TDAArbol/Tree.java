...
public interface Tree<E> extends Iterable<E> {
	 ...
	 * La colección iterable considera un recorrido desde el nodo que representa el hijo extremo izquierdo hacia el nodo que representa el hijo extremo derecho.
	 * @param v Posición de un nodo.
	...
	/**
	 * Elimina el nodo referenciado por una posición dada. 
	 * Si se trata de un nodo interno, los hijos del nodo eliminado lo reemplazan en el mismo orden en el que aparecen. 
	 * Si el nodo a eliminar es la raíz del árbol,  únicamente podrá ser eliminado si tiene un solo hijo, el cual lo reemplazará.
	 * @param p Posición del nodo a eliminar.
